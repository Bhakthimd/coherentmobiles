-- Table: public.phone_variants

-- DROP TABLE IF EXISTS public.phone_variants;
...
(
    ...
    CONSTRAINT fk_variant_model FOREIGN KEY (model_id)
        REFERENCES public.phone_models (model_id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE CASCADE,
...
ALTER TABLE IF EXISTS public.phone_variants
    OWNER to postgres;